...
export const zh = {
  ...
  refresh: '刷新',
  refreshing: '正在后台刷新状态…',
  trayRefreshing: '正在后台刷新桌面启动状态，基础功能仍可使用。',
  trayStatusUnavailable: '暂时无法读取托盘状态，可稍后刷新重试。',
  checkUpdate: '检查更新',
  installUpdate: '安装更新',
...
export const en = {
  ...
  refresh: 'Refresh',
  refreshing: 'Refreshing status in the background…',
  trayRefreshing: 'Refreshing desktop launch status in the background. Basic actions remain available.',
  trayStatusUnavailable: 'Tray status is temporarily unavailable. Refresh again later.',
