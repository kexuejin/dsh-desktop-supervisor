...
await run('node', [
  ...
  '--tag', 'v0.1.0-dev.4',
  '--base-url', 'https://example.invalid/releases/download/v0.1.0-dev.4',
  '--assets-dir', assets,
...
if (latest.version !== '0.1.0-dev.4' || latest.platforms['darwin-aarch64-app']?.signature !== 'trusted signature' || latest.platforms['windows-x86_64-nsis']?.signature !== 'windows signature') {
